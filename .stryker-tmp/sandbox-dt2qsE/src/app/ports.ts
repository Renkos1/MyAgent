 ...
 */
const _kindsMatch: KindsMatch = stryMutAct_9fa48("33")
  ? false
  : (stryCov_9fa48("33"), true);
void _kindsMatch;
...
export function toOutcome(res: LlmResponse): TurnOutcome {
  if (stryMutAct_9fa48("34")) {
    ...
    stryCov_9fa48("34");
    switch (res.kind) {
      case stryMutAct_9fa48("36")
        ? ""
        : (stryCov_9fa48("36"), "tool-requested"):
        if (stryMutAct_9fa48("35")) {
        } else {
          stryCov_9fa48("35");
          return stryMutAct_9fa48("37")
            ? {}
            : (stryCov_9fa48("37"),
              {
                kind: stryMutAct_9fa48("38")
                  ? ""
                  : (stryCov_9fa48("38"), "tool-requested"),
                toolCount: res.calls.length,
              });
        }
      case stryMutAct_9fa48("40") ? "" : (stryCov_9fa48("40"), "completed"):
        if (stryMutAct_9fa48("39")) {
        } else {
          stryCov_9fa48("39");
          return stryMutAct_9fa48("41")
            ? {}
            : (stryCov_9fa48("41"),
              {
                kind: stryMutAct_9fa48("42")
                  ? ""
                  : (stryCov_9fa48("42"), "completed"),
              });
        }
      case stryMutAct_9fa48("44") ? "" : (stryCov_9fa48("44"), "truncated"):
        if (stryMutAct_9fa48("43")) {
        } else {
          stryCov_9fa48("43");
          return stryMutAct_9fa48("45")
            ? {}
            : (stryCov_9fa48("45"),
              {
                kind: stryMutAct_9fa48("46")
                  ? ""
                  : (stryCov_9fa48("46"), "truncated"),
              });
        }
      case stryMutAct_9fa48("48") ? "" : (stryCov_9fa48("48"), "refused"):
        if (stryMutAct_9fa48("47")) {
        } else {
          stryCov_9fa48("47");
          return stryMutAct_9fa48("49")
            ? {}
            : (stryCov_9fa48("49"),
              {
                kind: stryMutAct_9fa48("50")
                  ? ""
                  : (stryCov_9fa48("50"), "refused"),
              });
        }
      case stryMutAct_9fa48("52") ? "" : (stryCov_9fa48("52"), "empty"):
        if (stryMutAct_9fa48("51")) {
        } else {
          stryCov_9fa48("51");
          return stryMutAct_9fa48("53")
            ? {}
            : (stryCov_9fa48("53"),
              {
                kind: stryMutAct_9fa48("54")
                  ? ""
                  : (stryCov_9fa48("54"), "empty"),
              });
        }
    }
  }
